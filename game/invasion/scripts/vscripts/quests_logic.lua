...
function ApplyKunkkaQuests(data)
	--for k,v in pairs(data) do
	--	print(k)
	--end
	if data.target:GetUnitName() == "npc_kunkka_quest" then
		data.caster:RemoveItem(data.ability)

	end
end


function StartKQProvisions(data)
	...
	Timers:CreateTimer(1,function()
		...
		--CreateUnitByName("npc_crate_of_provisions", point(RandomInt(1,#point), true, nil, nil, DOTA_TEAM_BADGUYS )
