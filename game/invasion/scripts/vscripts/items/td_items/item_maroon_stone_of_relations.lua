...
if item_maroon_stone_of_relations == nil then
    item_maroon_stone_of_relations = class({})
end
...
item = item_maroon_stone_of_relations


function GetSkillName()
    return "skill_black_dragon_splash_attack"
end
